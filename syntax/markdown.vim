...
syn cluster markdownInline contains=markdownLineBreak,markdownLinkText,markdownBold,markdownCode,markdownEscape,@htmlTop,markdownError,markdownValid
...
exe 'syn region markdownBold matchgroup=markdownBoldDelimiter start="\*\*\S\@=" end="\S\@<=\*\*\|^$" skip="\\\*" contains=markdownLineStart,@Spell' . s:concealends
exe 'syn region markdownBold matchgroup=markdownBoldDelimiter start="\w\@<!__\S\@=" end="\S\@<=__\w\@!\|^$" skip="\\_" contains=markdownLineStart,@Spell' . s:concealends
...
hi markdownLink ctermfg=145 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
match markdownLink "\[\[[a-zA-Z0-9]\{2,}\]\]"
